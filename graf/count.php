...
//print_r($q1);die;
 ...
 $DataSet->AddPoint($q3,"Serie2");
 
 $DataSet->AddPoint($q2,"Serie3");
 
 $DataSet->AddPoint(array("Jan","Jan2","Jan3","Feb4","Feb5"),"Serie4");  
 ...
 $DataSet->SetSerieName("Пирогова2","Serie2");  

 $DataSet->SetSerieName("Артема7","Serie3");
 ...
 $Test->drawTitle(60,22,"Приемки за ".date("Y"),50,50,50,585);  
