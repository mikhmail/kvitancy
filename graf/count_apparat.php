...
<img src="http://technodoctor.com.ua/stat/graf/count_apparat_all.php?id_aparat=<?=$_GET["id_aparat"]?>&aparat_name=<?=$aparat_name?>&id_proizvod=<?=$_GET["id_proizvod"]?>&name_proizvod=<?=$name_proizvod?>"><hr>
