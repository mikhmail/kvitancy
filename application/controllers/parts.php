...
class Parts extends CI_Controller {
    ...
    public function index()
    {
        ...
        //pagination settings
        $config['per_page'] = 10;
        $config['base_url'] = base_url() . 'parts/';
        ...
        if ($this->input->post() OR $this->uri->segment(2)) {
            ...
            $data['count_store'] = $this->parts_model->get_store(
                $search_string,
                $order,
                $order_type,
                $limit_start,
...
//clear session data in session
    ...
    public function return_store()
    {
        ...
        $id = $this->uri->segment(3);
        //var_dump($id);die;
        $this->parts_model->return_store($id);
        redirect('store');
    ...
    public function update()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            if ($this->form_validation->run())
            {
                ...
                if($this->parts_model->update_store($id, $data_to_store) == TRUE){
        ...
        //product data
        $data['store'] = $this->parts_model->get_store_by_id($id);
