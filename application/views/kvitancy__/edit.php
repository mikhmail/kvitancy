    <div class="container top">
      ...
      <ul class="breadcrumb">
        ...
        <li>
          <a href="<?php echo site_url().'/'.$this->uri->segment(2); ?>">
      ...
      <div class="page-header">
        <h2>
          Обновление <?php echo ucfirst($this->uri->segment(2));?> # <?php echo ucfirst($this->uri->segment(3));?>
        </h2>
      </div>
      ...
      echo form_open('kvitancy/update/'.$this->uri->segment(3).'', $attributes);
      ?>
