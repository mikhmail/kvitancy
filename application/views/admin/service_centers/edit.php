    <div class="container top">
      ...
      echo form_open('admin/service_centers/update/'.$this->uri->segment(4).'', $attributes);
      ?>
        <fieldset>
          <div class="control-group">
            <label for="inputError" class="control-label">Название</label>
            <div class="controls">
              <input type="text" id="" name="name_sc" value="<?php echo $manufacture[0]['name_sc']; ?>" >
            </div>
          </div>
		   ...
		   <div class="control-group">
            ...
            <div class="controls">
              <textarea id="" rows="5" name="adres_sc"><?php echo $manufacture[0]['adres_sc']; ?></textarea>
            </div>
          </div>
		   ...
		   <div class="control-group">
            ...
            <div class="controls">
              <textarea id="" rows="3" name="rab_sc"><?php echo $manufacture[0]['rab_sc']; ?></textarea>
            </div>
          </div>
		  ...
		  <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="mail_sc" value="<?php echo $manufacture[0]['mail_sc']; ?>" >
            </div>
          </div>
		  ...
		  <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="site" value="<?php echo $manufacture[0]['site']; ?>" >
            </div>
          </div>
