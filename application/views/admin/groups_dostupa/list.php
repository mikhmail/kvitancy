            ...
            <tbody>
              ...
              foreach($groups_dostupa as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/groups_dostupa/update/'.$row['id'].'" class="btn btn-info">Изменить</a>  
                  <a href="'.site_url("admin").'/groups_dostupa/delete/'.$row['id'].'" class="btn btn-danger">Удалить</a>
                </td>';
                echo '</tr>';
              }
              ?>      
