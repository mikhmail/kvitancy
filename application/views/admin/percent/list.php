...
<ul class="breadcrumb" style="margin-bottom: 20px;">
    <li>
        <a href="<?php echo site_url("percent/"); ?>">
...
echo form_open('percent', array('class' => 'form-inline', 'id' => 'myform'));
        ...
        <td>
            ...
            <table class="table">
                <tr class="chart-bottom-heading">
                    ...
                    <td class="span3">
                        <?if(count($store)>0 OR count($cash) >0) {?>
                        Приход ([<b><?=$pro_cash?></b>] - Запчасти[<b><?=$sum_store?></b>]] )×<b><?=$this->session->userdata('percent')?>%</b> = <b><?=(($pro_cash-$sum_store)*$this->session->userdata('percent'))/100;?></b>
                    <?}?>
                    </td>
