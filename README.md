...
Запутался в логике стата, запчасти как считать? цені покупки или продажи?
Доделал вывод стата, надо придумать как прибыль и общую считать и показывать
Надо проверить воркс контроллер, там $start_date = date('Y') . '-'. $m . '-31' считает с прошлого месяца 31го числа...
