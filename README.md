...
------
Надо проверить вывод зп инженера по крайным числам, 1число <=
Надо сделать вывод оборота сц - сделал стат контроллер...модель, вьюв...
Надо сделать ручную кассу, и сверять с оборотом сц, последний день не работает AND cash.update_time <=  '2016-01-29%'
Надо сделать взаиморасчеты с поставщиками
